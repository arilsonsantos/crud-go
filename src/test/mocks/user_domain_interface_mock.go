...
// Source: src/model/domain/UserDomainInerface.go
//
// Generated by this command:
//
//	mockgen -source=src/model/domain/UserDomainInerface.go -destination=src/test/mocks/user_domain_interface_mock.go -package=mocks
//
...
func (m *MockUserDomainInterface) GenerateToken() (string, *errors.ErrorDto) {
	m.ctrl.T.Helper()
...
func (m *MockUserDomainInterface) SetID(string2 string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetID", string2)
}

// SetID indicates an expected call of SetID.
func (mr *MockUserDomainInterfaceMockRecorder) SetID(string2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetID", reflect.TypeOf((*MockUserDomainInterface)(nil).SetID), string2)
}
